...
def generate_launch_description():
    ...
    gz_bridge_node = Node(
        ...
        arguments=[
            ...
            #"/tf@tf2_msgs/msg/TFMessage@gz.msgs.Pose_V", since we added EKF node
            #"/camera/image@sensor_msgs/msg/Image@gz.msgs.Image", as we added anode that compress in background
            "/camera/camera_info@sensor_msgs/msg/CameraInfo@gz.msgs.CameraInfo",
            "imu@sensor_msgs/msg/Imu@gz.msgs.IMU",
            "/navsat@sensor_msgs/msg/NavSatFix@gz.msgs.NavSat",
            "/scan@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan", #lidar
            "/scan/points@sensor_msgs/msg/PointCloud2@gz.msgs.PointCloudPacked", #for 3d scan
